...
draw:function(layer, playername){
    if( layer=="OnWater" && PlayersData.get(playername).prevX!= null){
        let sin = 0
        let cos = 0
        let sinc = 0
        let cosc = 0
...
drawp:function(layer, playername){
    ...
    if( layer=="OnWater" && PlayersData.has(playername)){
        let sin = 0
        let cos = 0
        let sinc = 0
        let cosc = 0
...
f:{
        ...
        '6':'#723636'},
draw:function(layer, playername){
    if( layer=="OnWater-1" && PlayersData.get(playername).prevX!= null){
        let sin = 0
        let cos = 0
        let sinc = 0
        let cosc = 0
...
//	    ctx.lineJoin = 'miter';
    ...
    }else if (layer == "Info+1"  && PlayersData.get(playername).prevX!= null){
...
f:{
        ...
        '6':'#723636'},
draw:function(layer, playername){
    if( ((layer=="OnWater-1" && PlayersData.get(playername).Z == 0 ) || (layer=="OnGround" && PlayersData.get(playername).Z == 1)) && PlayersData.get(playername).prevX!= null){
        let sin = 0
        let cos = 0
        let sinc = 0
        let cosc = 0
...
drawp:function(layer, playername){
    if( (layer=='OnWater-1' && Z == 0 ) || (layer=='OnGround' && Z == 1)){
        let sin = 0
        let cos = 0
        let sinc = 0
        let cosc = 0
...
f:{
        ...
        '6':'#723636'},
draw:function(layer, playername){
    if( layer=="Air-1"  && PlayersData.get(playername).prevX!= null){
        let sin = 0
        let cos = 0
        let sinc = 0
        let cosc = 0
...
f:{
        ...
        '6':'#723636'},
draw:function(layer, playername){
    if( layer=="Air"  && PlayersData.get(playername).prevX!= null){
        let sin = 0
        let cos = 0
        let sinc = 0
        let cosc = 0
