    ...
    while True:
        ...
        for bullet in Bullets.keys():
            try:
                ...
                Bullets[bullet][4] = math.cos(Bullets[bullet][7] / 180 * math.pi) * (
                        Bullets[bullet][6] - Bullets[bullet][10]) * int(
                    Bullets[bullet][6] - Bullets[bullet][10] > 0)
                Bullets[bullet][5] = math.sin(Bullets[bullet][7] / 180 * math.pi) * (
                        Bullets[bullet][6] - Bullets[bullet][10]) * int(
                    Bullets[bullet][6] - Bullets[bullet][10] > 0)

                Bullets[bullet][12] = LineString(
                    [[Bullets[bullet][0] + Bullets[bullet][2], Bullets[bullet][1] + Bullets[bullet][3]],
                     [Bullets[bullet][0] + Bullets[bullet][4], Bullets[bullet][1] + Bullets[bullet][5]]])
                try:
                    for _ in MAP['Q'][(int((Bullets[bullet][2] + Bullets[bullet][0]) // 1),
                                       int((Bullets[bullet][3] + Bullets[bullet][1]) // 1))]['PLAYERS']:
                        if _ in PlayersData.keys() and _ != Bullets[bullet][11] and PlayersData[_]['Z'] == \
                                Bullets[bullet][17] and not PlayersData[_]['TAKEN']:
                            # print(_)
                            if PlayersData[_]['COL'].intersects(Bullets[bullet][12]):
                                Bullets[bullet][2] = PlayersData[_]['COL'].intersection(Bullets[bullet][12]).coords[1][
                                                         0] - Bullets[bullet][0]
                                Bullets[bullet][3] = PlayersData[_]['COL'].intersection(Bullets[bullet][12]).coords[1][
                                                         1] - Bullets[bullet][1]
                                if PlayersData[_]['STATUS'] == 'ALIVE' and not Bullets[bullet][11] in Teams[
                                    PlayersData[_]['TEAM']]:
                                    ilist = []
                                    for l in range(0, len(PlayersData[_]['COL'].exterior.coords)):
                                        tl = LineString([PlayersData[_]['COL'].exterior.coords[l],
                                                         PlayersData[_]['COL'].exterior.coords[
                                                             (l + 1) % len(PlayersData[_]['COL'].exterior.coords)]])
                                        ...
                                        if tl.intersects(Bullets[bullet][12]):
                                            ...
                                            c = ((a[1][0] - a[0][0]) * (b[1][0] - b[0][0]) + (a[1][1] - a[0][1]) * (
                                                    b[1][1] - b[0][1])) / a_ / b_
                                    ...
                                    ln = LineString([(Bullets[bullet][12].coords[:][0][0] - (
                                            Bullets[bullet][12].coords[:][1][0] - Bullets[bullet][12].coords[:][0][
                                        0]) * 20, Bullets[bullet][12].coords[:][0][1] - (
                                                              Bullets[bullet][12].coords[:][1][1] -
                                                              Bullets[bullet][12].coords[:][0][1]) * 20), (
                                                         Bullets[bullet][12].coords[:][0][0] + (
                                                                 Bullets[bullet][12].coords[:][1][0] -
                                                                 Bullets[bullet][12].coords[:][0][0]) * 20,
                                                         Bullets[bullet][12].coords[:][0][1] + (
                                                                 Bullets[bullet][12].coords[:][1][1] -
                                                                 Bullets[bullet][12].coords[:][0][1]) * 20)])
                                    cof = PlayersData[_]['COL'].intersection(ln).length / \
                                          vehicleinfo[PlayersCosmetics[_]['VEHICLE']]['PENDMGDST']
                                    if cof > 1: cof = 1
                                    ...
                                    PlayersData[_]['HP'] -= round(Bullets[bullet][13] * cof * sin ** (
                                            vehicleinfo[PlayersCosmetics[_]['VEHICLE']]['DEGDMGCOF'] *
                                            caninfo[Bullets[bullet][18]][10]))
                ...
                try:
                    for _ in MAP['Q'][(int((Bullets[bullet][2] + Bullets[bullet][0]) // 1),
                                       int((Bullets[bullet][3] + Bullets[bullet][1]) // 1))]['S']:
                ...
                if Bullets[bullet][14] > 0:
                    ...
                    delarr.append(bullet)
                    continue
                for x in range(int((Bullets[bullet][2] + Bullets[bullet][0]) // 1) - 1,
                               int((Bullets[bullet][2] + Bullets[bullet][0]) // 1) + 2):
                    for y in range(int((Bullets[bullet][3] + Bullets[bullet][1]) // 1) - 1,
                                   int((Bullets[bullet][3] + Bullets[bullet][1]) // 1) + 2):
                        try:
                            # del MAP['Q'][(x, y)]['BULLETS'][bullet]
                ...
                try:
                    MAP['Q'][(int((Bullets[bullet][2] + Bullets[bullet][0]) // 1),
                              int((Bullets[bullet][3] + Bullets[bullet][1]) // 1))]['BULLETS'].add(bullet)
                except:
                    pass
            except Exception:
                pass
        ...
        for aarocket in AARockets.keys():
            try:
                ...
                AARockets[aarocket][8] = LineString(
                    [[AARockets[aarocket][0] + AARockets[aarocket][2], AARockets[aarocket][1] + AARockets[aarocket][3]],
                     [AARockets[aarocket][0] + AARockets[aarocket][2] - math.cos(
                         AARockets[aarocket][5] / 180 * math.pi) * deltaS,
                      AARockets[aarocket][1] + AARockets[aarocket][3] - math.sin(
                          AARockets[aarocket][5] / 180 * math.pi) * deltaS]])
                if AARockets[aarocket][10] != 3 and AARockets[aarocket][10] != 2:
                    try:
                        for _ in MAP['Q'][(int((AARockets[aarocket][2] + AARockets[aarocket][0]) // 1),
                                           int((AARockets[aarocket][3] + AARockets[aarocket][1]) // 1))]['PLAYERS']:
                            ...
                            if _ in PlayersData.keys() and _ != AARockets[aarocket][7] and PlayersData[_]['Z'] == 1:
                                ...
                                if PlayersData[_]['COL'].intersects(AARockets[aarocket][8]):
                                    ...
                                    if PlayersData[_]['STATUS'] == 'ALIVE' and not _ in Teams[PlayersData[_]['TEAM']]:
                                        ...
                                        PlayersData[AARockets[aarocket][7]]['SCORES'] += AARockets[aarocket][9] + \
                                                                                         PlayersData[_]['HP']
                ...
                if AARockets[aarocket][10] == 1 or AARockets[aarocket][10] == 4:
                    ...
                    delarr.append(aarocket)
                    continue
                for x in range(int((AARockets[aarocket][2] + AARockets[aarocket][0]) // 1) - 1,
                               int((AARockets[aarocket][2] + AARockets[aarocket][0]) // 1) + 2):
                    for y in range(int((AARockets[aarocket][3] + AARockets[aarocket][1]) // 1) - 1,
                                   int((AARockets[aarocket][3] + AARockets[aarocket][1]) // 1) + 2):
                        try:
                            ...
                            pass
                try:
                    MAP['Q'][(int((AARockets[aarocket][2] + AARockets[aarocket][0]) // 1),
                              int((AARockets[aarocket][3] + AARockets[aarocket][1]) // 1))]['AAROCKETS'].add(aarocket)
                except:
                    pass
            except Exception:
                pass
        ...
        for torpedo in Torpedos.keys():
            try:
                ...
                Torpedos[torpedo][8] = LineString(
                    [[Torpedos[torpedo][0] + Torpedos[torpedo][2], Torpedos[torpedo][1] + Torpedos[torpedo][3]], [
                        Torpedos[torpedo][0] + Torpedos[torpedo][2] - math.cos(Torpedos[torpedo][5] / 180 * math.pi) *
                        Torpedos[torpedo][6] / TPS,
                        Torpedos[torpedo][1] + Torpedos[torpedo][3] - math.sin(Torpedos[torpedo][5] / 180 * math.pi) *
                        Torpedos[torpedo][6] / TPS]])
                try:
                    for _ in MAP['Q'][(int((Torpedos[torpedo][2] + Torpedos[torpedo][0]) // 1),
                                       int((Torpedos[torpedo][3] + Torpedos[torpedo][1]) // 1))]['PLAYERS']:
                        ...
                        if _ in PlayersData.keys() and _ != Torpedos[torpedo][7] and PlayersData[_]['Z'] == 0:
                            ...
                            if PlayersData[_]['COL'].intersects(Torpedos[torpedo][8]):
                                ...
                                if PlayersData[_]['STATUS'] == 'ALIVE' and not _ in Teams[PlayersData[_]['TEAM']]:
                                    ...
                                    PlayersData[_]['HP'] -= int(
                                        Torpedos[torpedo][9] * p.intersection(PlayersData[_]['COL']).area / p.area)

                                    PlayersData[_]['LASTDMG'] = datetime.datetime.now()

                                    PlayersData[Torpedos[torpedo][7]]['SCORES'] += Torpedos[torpedo][9] + \
                                                                                   PlayersData[_]['HP']
                ...
                try:
                    for _ in MAP['Q'][(int((Torpedos[torpedo][2] + Torpedos[torpedo][0]) // 1),
                                       int((Torpedos[torpedo][3] + Torpedos[torpedo][1]) // 1))]['S']:
                ...
                if Torpedos[torpedo][10] == 1:
                    ...
                    delarr.append(torpedo)
                    continue
                for x in range(int((Torpedos[torpedo][2] + Torpedos[torpedo][0]) // 1) - 1,
                               int((Torpedos[torpedo][2] + Torpedos[torpedo][0]) // 1) + 2):
                    for y in range(int((Torpedos[torpedo][3] + Torpedos[torpedo][1]) // 1) - 1,
                                   int((Torpedos[torpedo][3] + Torpedos[torpedo][1]) // 1) + 2):
                        try:
                            ...
                            pass
                try:
                    MAP['Q'][(int((Torpedos[torpedo][2] + Torpedos[torpedo][0]) // 1),
                              int((Torpedos[torpedo][3] + Torpedos[torpedo][1]) // 1))]['TORPEDOS'].add(torpedo)
                except:
                    pass
            except Exception:
                pass
            ...
            try:
                ...
                for phf in MAP['Q'][(int(Zones[zone][0] // 1), int(Zones[zone][1] // 1))]['PLAYERS']:
                    if (PlayersData[phf]['X'] - Zones[zone][0]) ** 2 + (PlayersData[phf]['Y'] - Zones[zone][1]) ** 2 < (
                        ...
                        'MAXSPEED'] * 0.3 > PlayersData[phf]['SPEED'] > vehicleinfo[PlayersCosmetics[phf]['VEHICLE']][
                        'MAXSPEED'] * -0.3:
                        players.add(phf)
                ...
                if len(players) > 1:
                    ...
                    for player in range(1, len(players)):
                        if PlayersData[players[player]]['TEAM'] != PlayersData[players[player - 1]]['TEAM'] and not \
                                PlayersData[players[player]]['TEAM'] is None:
                            gvgt = False
                            break
                    if gvgt:
                        Zones[zone][2] = 'team'
                        ...
                        for pl in players:
                            if (datetime.datetime.now() - PlayersData[pl]['EQZNUPDTTIMER']).seconds > 30:
                                ...
                                if PlayersData[pl]['TORPEDOS'] < vehicleinfo[PlayersCosmetics[pl]['VEHICLE']][
                                    'TORPEDOS']:
                                    PlayersData[pl]['TORPEDOS'] += 1
                                if PlayersData[pl]['AAROCKETS'] < vehicleinfo[PlayersCosmetics[pl]['VEHICLE']][
                                    'AAROCKETS']:
                    ...
                    for _ in range(0, len(vehicleinfo[PlayersCosmetics[players[0]]['VEHICLE']]['CAN'])):
                        if (datetime.datetime.now() - PlayersData[players[0]]['EQZNUPDTTIMER']).seconds > 40:
                            if PlayersData[players[0]]['SMOKES'] < vehicleinfo[PlayersCosmetics[players[0]]['VEHICLE']][
                                'SMOKES']:
                                PlayersData[players[0]]['SMOKES'] += 1
                            if PlayersData[players[0]]['TORPEDOS'] < \
                                    vehicleinfo[PlayersCosmetics[players[0]]['VEHICLE']]['TORPEDOS']:
                                PlayersData[players[0]]['TORPEDOS'] += 1
                            if PlayersData[players[0]]['AAROCKETS'] < \
                                    vehicleinfo[PlayersCosmetics[players[0]]['VEHICLE']]['AAROCKETS']:
                                PlayersData[players[0]]['AAROCKETS'] += 1
                            if PlayersData[players[0]]['BOMBS'] < vehicleinfo[PlayersCosmetics[players[0]]['VEHICLE']][
                                'BOMBS']:
                                PlayersData[players[0]]['BOMBS'] += 1
                            PlayersData[players[0]]['EQZNUPDTTIMER'] = datetime.datetime.now()
                        PlayersData[players[0]]['AMMO'] = vehicleinfo[PlayersCosmetics[players[0]]['VEHICLE']][
                            'AMMO'].copy()
        ...
        for player in PlayersSockets.keys():
            try:
                ...
                pass
                # logging.exception("message")
            if player in PlayersInputs and PlayersData[player]["STATUS"] != 'DEAD' and PlayersData[player][
                "STATUS"] != 'AFK':
                if PlayersData[player]['HP'] < vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['HPMAX'] and (
                        datetime.datetime.now() - PlayersData[player]['LASTDMG']).seconds > 30:
                ...
                if vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['GASTYPE'] == 1:
                    ...
                    PlayersData[player]["SPEED"] += ((vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['MAXSPEED'] * (
                            0.25 + 0.75 * int(PlayersData[player]['GAS'] != 'LANDING'))) - PlayersData[player][
                                                         "SPEED"]) * vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                                        'BOOST']
                else:
                    if not PlayersData[player]['ONGROUND']:
                        PlayersData[player]["SPEED"] += ((vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['MAXSPEED'] *
                                                          PlayersData[player]['GAS'] / 100) - PlayersData[player][
                                                             "SPEED"]) * \
                                                        vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['BOOST']
                    else:
                        PlayersData[player]["SPEED"] += ((vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                                              'GROUNDSPEED'] * PlayersData[player]['GAS'] / 100) -
                                                         PlayersData[player]["SPEED"]) * \
                                                        vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                                            'GROUNDBOOST']  # vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['GROUNDSPEED']*PlayersData[player]['GAS']/100
                PlayersData[player]["X"] += math.cos(PlayersData[player]['DIR'] / 180 * math.pi) * PlayersData[player][
                    'SPEED'] / TPS
                PlayersData[player]["Y"] += math.sin(PlayersData[player]['DIR'] / 180 * math.pi) * PlayersData[player][
                    'SPEED'] / TPS
                if PlayersData[player]['X'] > WH or PlayersData[player]['X'] < 0 or PlayersData[player]['Y'] > WH or \
                        PlayersData[player]['Y'] < 0:
                ...
                mx, my = 0, 0
                ms = 0
                if (vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['COLB'] or not PlayersData[player][
                    'ONGROUND']) and not PlayersData[player]['TAKEN'] and \
                        vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['Z'] == 0:
                    try:
                        for _ in list(PlayersData[player]['VISB']):
                            if PlayersData[player]['COL'].intersects(MAP['B'][_]):
                                    ...
                                    if ln.intersects(PlayersData[player]['COL']):
                                        if MAPobjSIDEdir['B'][_]:
                                            if (cords[(l + 1) % len(cords)][0] - cords[l][0]) * (
                                                ...
                                                # print()
                                                mx -= ((cords[l][1] - cords[(l + 1) % len(cords)][1]) / math.sqrt(
                                                    (cords[(l + 1) % len(cords)][0] - cords[l][0]) ** 2 + (
                                                            cords[(l + 1) % len(cords)][1] - cords[l][
                                                        1]) ** 2)) * abs(
                                                    PlayersData[player]['SPEED']) / TPS * math.sqrt(1 - (
                                                        abs((cords[(l + 1) % len(cords)][1] - cords[l][1]) * (
                                                                PlayersData[player]['SPEED'] / abs(
                                                            PlayersData[player]['SPEED'])) * math.sin(
                                                            PlayersData[player]['DIR'] / 180 * math.pi) + (
                                                                    cords[(l + 1) % len(cords)][0] - cords[l][
                                                                0]) * (PlayersData[player]['SPEED'] / abs(
                                                            PlayersData[player]['SPEED'])) * math.cos(
                                                            PlayersData[player][
                                                                'DIR'] / 180 * math.pi)) / math.sqrt(
                                                    (cords[(l + 1) % len(cords)][0] - cords[l][0]) ** 2 + (
                                                            cords[(l + 1) % len(cords)][1] - cords[l][
                                                        1]) ** 2)) ** 2)
                                                my -= ((cords[(l + 1) % len(cords)][0] - cords[l][0]) / math.sqrt(
                                                    (cords[(l + 1) % len(cords)][0] - cords[l][0]) ** 2 + (
                                                            cords[(l + 1) % len(cords)][1] - cords[l][
                                                        1]) ** 2)) * abs(
                                                    PlayersData[player]['SPEED']) / TPS * math.sqrt(1 - (
                                ...
                                break
                        for _ in list(PlayersData[player]['VISC']):
                            if PlayersData[player]['COL'].intersects(MAP['C'][_]):
                                cords = MAP['C'][_].exterior.coords
                                for l in range(0, len(cords)):
                                    ln = LineString([cords[l], cords[(l + 1) % len(cords)]])
                                    if ln.intersects(PlayersData[player]['COL']):
                                        if MAPobjSIDEdir['C'][_]:
                                            if (cords[(l + 1) % len(cords)][0] - cords[l][0]) * (
                                                    PlayersData[player]['SPEED'] / abs(
                                                PlayersData[player]['SPEED'])) * math.sin(
                                                PlayersData[player]['DIR'] / 180 * math.pi) + (
                        ...
                        pass
                        # logging.exception("message")
                if not vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['COLB'] and not PlayersData[player]['TAKEN'] and \
                        vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['Z'] == 0:
                    try:
                        brg_col = False
                        b_col = False
                ...
                if vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['TAKEN']:
                    try:
                        for _ in list(
                            ...
                            if PlayersData[player]['GAS'] == 'LANDING' and vehicleinfo[PlayersCosmetics[_]['VEHICLE']][
                                'CARRIER'] and PlayersCosmetics[player]['VEHICLE'] in \
                                    vehicleinfo[PlayersCosmetics[_]['VEHICLE']]['CARVEH'] and _ != player and \
                                    PlayersData[player]['COL'].intersects(PlayersData[_]['COL']) and _ in Teams[
                                PlayersData[player]['TEAM']]:
                                # print('!!!!!!!!!!!!!!!!!!!!!!!')
                                ...
                                PlayersData[player]['TORPEDOS'] = vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                    'TORPEDOS']
                                PlayersData[player]['AAROCKETS'] = vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                    'AAROCKETS']
                                PlayersData[player]['BOMBS'] = vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['BOMBS']
                                # PlayersData[player]['CAN'] = []
                                PlayersData[player]['KSR'] = 1
                                PlayersData[player]['AMMO'] = vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                    'AMMO'].copy()
                                # wasCol = True
                                break
                    except Exception:
                ...
                if vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['COLP'] and not PlayersData[player]['TAKEN']:
                    try:
                        for _ in list(
                                MAP['Q'][(int(PlayersData[player]['X'] // 1), int(PlayersData[player]['Y'] // 1))][
                                    'PLAYERS']):
                            if _ != player and PlayersData[player]['COL'].intersects(PlayersData[_]['COL']) and \
                                    vehicleinfo[PlayersCosmetics[_]['VEHICLE']]['COLP']:
                                # PlayersData[player]["X"] -= math.cos(PlayersData[player]['DIR'] / 180 * math.pi) * (vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['SPEED']*int(not PlayersData[player]['ONGROUND'])+vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['GROUNDSPEED']*int( PlayersData[player]['ONGROUND']))/TPS * (PlayersData[player]['GAS'] / 100)*1
                                # PlayersData[player]["Y"] -= math.sin(PlayersData[player]['DIR'] / 180 * math.pi) * (vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['SPEED']*int(not PlayersData[player]['ONGROUND'])+vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['GROUNDSPEED']*int( PlayersData[player]['ONGROUND']))/TPS * (PlayersData[player]['GAS'] / 100)*1
                                mx -= math.cos(PlayersData[player]['DIR'] / 180 * math.pi) * PlayersData[player][
                                    'SPEED'] / TPS
                                my -= math.sin(PlayersData[player]['DIR'] / 180 * math.pi) * PlayersData[player][
                                    'SPEED'] / TPS
                                PlayersData[player]['DIR'] = PlayersData[player]['PrevDIR']
                                ms += 1
                                wasCol = True
                ...
                if PlayersInputs[player]['ak'] and PlayersData[player]['STATUS'] != "BURNING":
                    if vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['MOVETYPE'] < 2 or (
                            PlayersCosmetics[player]['VEHICLE'] in [5] and PlayersInputs[player]['view'] > 0):
                        if not PlayersData[player]['ONGROUND']:
                            if PlayersData[player]['SPEED'] > vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                'MAXSPEED']:
                                PlayersData[player]['DIR'] = barrier(
                                    PlayersData[player]['DIR'] - vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                        'TURN'] / TPS * math.sin(2), min=0, minrep=359, max=359, maxrep=0)
                            else:
                                PlayersData[player]['DIR'] = barrier(
                                    PlayersData[player]['DIR'] - vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                        'TURN'] / TPS * math.sin(
                                        PlayersData[player]['SPEED'] / vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                            'MAXSPEED'] * 2), min=0, minrep=359, max=359, maxrep=0)
                        else:
                            PlayersData[player]['DIR'] = barrier(
                                PlayersData[player]['DIR'] - vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                    'TURN'] / TPS * (math.sin(
                                    PlayersData[player]['SPEED'] / vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                        'GROUNDSPEED'] * math.pi) * 0.5 + 0.75), min=0, minrep=359, max=359, maxrep=0)
                        ...
                        if not PlayersData[player]['ONGROUND']:
                            ...
                            PlayersData[player]['DIR'] = barrier(
                                PlayersData[player]['DIR'] + vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                    ...
                                    PlayersData[player]['SPEED'] / vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                        'GROUNDSPEED'] * math.pi) * 0.5 + 0.75), min=0, minrep=359, max=359, maxrep=0)
                if vehicleinfo[PlayersCosmetics[player]['VEHICLE']]['MOVETYPE'] == 2 and (
                        not (PlayersCosmetics[player]['VEHICLE'] in [5] and PlayersInputs[player]['view'] > 0)):
                    if PlayersData[player]['STATUS'] != "BURNING":
                        dir = lookat(PlayersInputs[player]['x'], PlayersInputs[player]['y'])
                        if abs(PlayersData[player]['DIR'] - dir) < vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                            'TURN'] / TPS:
                            PlayersData[player]['DIR'] = dir
                        else:
                            dir1 = dir - PlayersData[player]['DIR']
                            dir2 = PlayersData[player]['DIR'] - dir + 360 * (
                                    1 - 2 * int(PlayersData[player]['DIR'] > dir))
                            if abs(dir2) < abs(dir1):
                                PlayersData[player]['DIR'] -= dir2 / abs(dir2) * \
                                                              vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                                                  'TURN'] / TPS
                            else:
                                PlayersData[player]['DIR'] += dir1 / abs(dir1) * \
                                                              vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                                                                  'TURN'] / TPS
                            PlayersData[player]['DIR'] = PlayersData[player]['DIR'] % 360
                            if PlayersData[player]['DIR'] < 0:
                                PlayersData[player]['DIR'] += 360
                if PlayersData[player]['STATUS'] == "BURNING" and vehicleinfo[PlayersCosmetics[player]['VEHICLE']][
                    'MOVETYPE'] == 2:
        ...
        for _ in KickList:
            try:
                for x in range(int(PlayersData[_]['X'] // 1) - VIEW_X - 1, int(PlayersData[_]['X'] // 1) + VIEW_X + 2):
                    for y in range(int(PlayersData[_]['Y'] // 1) - VIEW_Y - 1,
                                   int(PlayersData[_]['Y'] // 1) + VIEW_Y + 2):
                        try:
            ...
            if PlayersAccs[_]["NICK"] != "":
                ...
                logger.info("change_player_data: " + str(
                    {"key": API_KEY, 'nickname': nickname, 'password': password, 'xp': xp, 'kills': kills,
                     'delta': delta, 'money': money}))

                async def change_player_data():
                    await requests.post(API_SERV_ADDRESS + "change_player_data",
                                        {"key": API_KEY, 'nickname': nickname, 'password': password, 'xp': xp,
                                         'kills': kills, 'delta': delta, 'money': money})
            ...
            PlayersAccs.pop(_)
    logger.info("Game loop ended WTF ?!?")
    # except Exception:
    # pass
    # logging.exception("message")
                ...
                if PlayersSockets[player] == websocket:
                    try:
                                            ...
                                            if _[1] == '/':
                                                if _[1:].lower().find('/team') == 0:
                                                    ...
                                                    if len(_[1:].lower().split(' ')) > 1:
                                                        # print(_[1:].lower())
                                                        if _[1:].lower().split(' ')[1] == 'create' and len(
                                                                _[1:].lower().split(' ')) > 2 and not \
                                                                _[1:].lower().split(' ')[2].replace(' ', '').replace(
                                                                    ',',
                                                                    '').replace(
                                                                    ']', '').replace('[', '') == "":

                                                            try:
                                                                if not _[1:].split(' ')[2].replace(' ', '').replace(',',
                                                                                                                    '').replace(
                                                                    ']', '').replace('[', '') in Teams.keys():
                                                                    if PlayersData[player]['TEAM'] is None:
                                                                        Teams[_[1:].split(' ')[2].replace(' ',
                                                                                                          '').replace(
                                                                            ',', '').replace(']', '').replace('[',
                                                                                                              '')] = [
                                                                            player]
                                                                        TeamsOwners[_[1:].split(' ')[2].replace(' ',
                                                                                                                '').replace(
                                                                            ',', '').replace(']', '').replace('[',
                                                                                                              '')] = player
                                                                        PlayersData[player]['TEAM'] = _[1:].split(' ')[
                                                                            2].replace(' ', '').replace(',',
                                                                                                        '').replace(']',
                                                                                                                    '').replace(
                                                                            '[', '')
                                                                        PlayersData[player]['MSGTURN'].append(
                                                                            f"\nc,{LastMSGI},4," + _[1:].split(' ')[
                                                                                2].replace(' ', '').replace(',',
                                                                                                            '').replace(
                                                                                ']', '').replace('[', ''))
                                                                        LastMSGI += 1
                                                        ...
                                                        # print(TeamsOwners)
                                                            ...
                                                            if not PlayersData[player]['TEAM'] is None:
                                                                ...
                                                                if TeamsOwners[PlayersData[player]['TEAM']] == player:
                                                                    if len(Teams[PlayersData[player]['TEAM']]) == 1:
                                                                        ...
                                                                        TeamsOwners[PlayersData[player]['TEAM']] = \
                                                                            Teams[PlayersData[player]['TEAM']][0]
                                                                        PlayersData[player]['TEAM'] = None
                                                                        TeamRec.pop(player)
                                                                else:
                                                            ...
                                                            if PlayersData[player]['TEAM'] is None:
                                                                try:
                                                                    PlayersData[TeamsOwners[_[1:].split(' ')[2]]][
                                                                        'MSGTURN'].append(f'\nj,{player},{LastMSGI}')
                                                                    LastMSGI += 1
                                                                    PlayersData[player]['TEAMREQ'].append(
                                                                        _[1:].split(' ')[2])
                                                                    PlayersData[player]['MSGTURN'].append(
                                                            ...
                                                            if TeamsOwners[PlayersData[player]['TEAM']] == player:
                                                                try:
                                                                    if PlayersData[player]['TEAM'] in \
                                                                            PlayersData[_[1:].split(' ')[2]]['TEAMREQ']:
                                                                        PlayersData[_[1:].split(' ')[2]]['TEAM'] = \
                                                                            PlayersData[player]['TEAM']
                                                                        TeamRec[_[1:].split(' ')[2]] = [
                                                                            PlayersData[player]['TEAM'],
                                                                            datetime.datetime.now()]
                                                                        PlayersData[_[1:].split(' ')[2]]['TEAMREQ'] = []
                                                                        Teams[PlayersData[player]['TEAM']].append(
                                                                            _[1:].split(' ')[2])
                                                                        for p in Teams[PlayersData[player]['TEAM']]:
                                                                            PlayersData[p]['MSGTURN'].append(
                                                                                f"\nc,{LastMSGI},9," + _[1:].split(' ')[
                                                                                    2])
                                                                        LastMSGI += 1
                                                                except:
                                                                    pass
                                                            ...
                                                            if TeamsOwners[PlayersData[player]['TEAM']] == player:
                                                                try:
                                                                    if _[1:].split(' ')[2] != player:
                                                                        Teams[PlayersData[player]['TEAM']].remove(
                                                                            _[1:].split(' ')[2])
                                                                        PlayersData[_[1:].split(' ')[2]]['TEAM'] = None
                                                                        for p in Teams[PlayersData[player]['TEAM']]:
                                                                            PlayersData[p]['MSGTURN'].append(
                                                                                f"\nc,{LastMSGI},8," + _[1:].split(' ')[
                                                                                    2])
                                                                        LastMSGI += 1
                                                                    else:
                                                                        PlayersData[player]['MSGTURN'].append(
                                                            ...
                                                            if PlayersData[player]['TEAM'] is None:
                                                                ...
                                                                if len(_[1:].lower().split(' ')) > 2 and \
                                                                        _[1:].lower().split(' ')[2].replace(' ',
                                                                                                            '') != '' and \
                                                                        _[1:].lower().split(' ')[2].count(',') == 0:
                                                                    for p in Teams[PlayersData[player]['TEAM']]:
                                                                        PlayersData[p]['MSGTURN'].append(
                        ...
                        if not player in PlayersData:
                            ...
                            if PlayersCosmetics[player]['VEHICLE'] in [5, 8]: PlayersData[player]['SPEED'] = 0.9 * \
                                                                                                             vehicleinfo[
                                                                                                                 PlayersCosmetics[
                                                                                                                     player][
                                                                                                                     'VEHICLE']][
                                        ...
                                        for j in range(-1, 2):
                                            try:
                                                for _ in MAP['Q'][(int(x) + i, int(y) + j)]['S']:
                                                    if MAP['S'][_].intersects(Point(x, y).buffer(0.25)):
                                                        inter = True
                                                        break
                                            except:
                                                pass
                                        ...
                                        for j in range(-1, 2):
                                            try:
                                                for _ in MAP['Q'][(int(x) + i, int(y) + j)]['B']:
                                                    if MAP['B'][_].intersects(Point(x, y).buffer(0.25)):
                                                        inter0 = True
                                                        break
                                            except:
                                                pass
