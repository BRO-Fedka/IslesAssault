...
POLY_SHAPE = [[-0.17,0.045],[-0.12,0.055],[0,0.055],[0.105,0.055],[0.155,0.035],[0.17,0],[0.155,-0.035],[0.105,-0.055],[0,-0.055],[-0.12,-0.055],[-0.17,-0.045]]
POLY_SHAPE_N = [(-0.01, 0.05), (-0.0, 0.12), (-0.0, 0.105), (0.02, 0.05), (0.035, 0.015), (0.035, -0.015), (0.02, -0.05), (-0.0, -0.105), (-0.0, -0.12), (-0.01, -0.05), (-0.09, 0.0)]
# POLY_SHAPE_N = count_normals(POLY_SHAPE)
# print(POLY_SHAPE_N)
SEG1 = [(-0.12, 0.055), (-0.07, 0.055), (-0.07, -0.055), (-0.12, -0.055), (-0.17, -0.045), (-0.17, 0.045), (-0.12, 0.055)]
SEG2 = [(0.0, 0.055), (0.055, 0.055), (0.055, -0.055), (0.0, -0.055), (-0.07, -0.055), (-0.07, 0.055), (0.0, 0.055)]
SEG3 = [(0.105, 0.055), (0.155, 0.035), (0.17, 0.0), (0.155, -0.035), (0.105, -0.055), (0.055, -0.055), (0.055, 0.055), (0.105, 0.055)]
...
class LandingShip(InteractiveVehicle):
    ...
    def update(self):
        ...
        self.interaction_access_shape = Point(self.body.position.x+math.cos(self.body.angle)*0.17,self.body.position.y+math.sin(self.body.angle)*0.17).buffer(0.13) #+math.sin(self.body.angle)*0.17
        line = LineString([[self.body.position.x+math.cos(self.body.angle)*0.15,self.body.position.y+math.sin(self.body.angle)*0.15],[self.body.position.x-math.cos(self.body.angle)*0.15,self.body.position.y-math.sin(self.body.angle)*0.15]]).buffer(0.04)
